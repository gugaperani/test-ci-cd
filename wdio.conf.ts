...
export const config = {
  ...
  //
  specs: ['./test-adjarabet/specs/ios/authorization.ts'],
  // Patterns to exclude.
  exclude: [
  ...
  //   "appium:platformVersion": "14",
  //   "appium:automationName": "UIAutomator2",
  //   "appium:device-name": "Pixel 5 API 34",
  //   "appium:app": projectPath.join(process.cwd(), "app/adjarabet.apk"),
  //   "appium:appActivity": "LoginActivity",
  //   "appium:autoGrantPermissions": true,  // Set to true to automatically grant app permissions
  //   "appium:language": "ka",   // Set language to Georgian (language code "ka")
  ...
  capabilities: [
    {
      ...
      'appium:app': path.join(process.cwd(), 'app/adjarabet/adjarabet.app'),
      'appium:automationName': 'XCUITest',
      'appium:bundleId': process.env.IOS_BUNDLE_ID || 'com.adjarabet.Mobile',
  ...
  logLevel: (process.env.LOG_LEVEL as any) || 'trace',
  //
