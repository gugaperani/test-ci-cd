const LoginScreen = require("../../screenObjects/both/Login.screen");
const HomeScreen = require("../../screenObjects/both/Home.screen");
// const ProfileScreen = require("../../screenObjects/both/Profile.screen");
...
describe('Authorization', () => {
  ...
  it.only('Login with valid credentials (save user)', async () => {
    await LoginScreen.login('gpiostest3', '@Qwerty0');
  ...
  it('OPTIONAL SDA Reverification module come up When such a user log into the app', async () => {
    await LoginScreen.loginRestricted('gpoptionalsda', '@Qwerty0');
  ...
  it('OPTIONAL OTP Reverification module come up When such a user log into the app', async () => {
    await LoginScreen.loginRestricted('gpoptionalotp', '@Qwerty0');
  ...
  it('EXPIRED OPTIONAL Reverification module come up When such a user log into the app', async () => {
    await LoginScreen.loginRestricted('gpexpiredoptional', '@Qwerty0');
